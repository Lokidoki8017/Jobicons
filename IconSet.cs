    ...
    internal class IconSet
    {
        ...
        public static void Initialize(JobIconsPlugin plugin)
        {
            ...
            Add("Grey", new int[] {
                ...
                91125, 91123, 91124, 91127, 91128, 91129, 91130, 91131 }, 2);
            Add("Black", new int[] {
                ...
                91625, 91623, 91624, 91627, 91628, 91629, 91630, 91631 }, 2);
            Add("Yellow", new int[] {
                ...
                92125, 92123, 92124, 92127, 92128, 92129, 92130, 92131 }, 2);
            Add("Orange", new int[] {
                ...
                92625, 92623, 92624, 92627, 92628, 92629, 92630, 92631 }, 2);
            Add("Red", new int[] {
                ...
                93125, 93123, 93124, 93127, 93128, 93129, 93130, 93131 }, 2);
            Add("Purple", new int[] {
                ...
                93625, 93623, 93624, 93627, 93628, 93629, 93630, 93631 }, 2);
            Add("Blue", new int[] {
                ...
                94125, 94123, 94124, 94127, 94128, 94129, 94130, 94131 }, 2);
            Add("Green", new int[] {
